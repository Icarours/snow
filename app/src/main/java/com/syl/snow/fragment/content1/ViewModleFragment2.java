 ...
 * @Called
 */
public class ViewModleFragment2 extends BaseFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_view_modle2, container, false);
        ...
        mBtnFragment1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mModle.getAccount().postValue(new AccountBean("lisi", "182*****008", "这段数据是从Fragment2中Post出来的"));
            }
        });
        return rootView;
    }
