...
import com.syl.snow.activity.FragmentTestActivity;
import com.syl.snow.activity.JsonDataActivity;
import com.syl.snow.base.BaseFragment;
import com.syl.snow.bean.CardBean;
import com.syl.snow.bean.ProvinceBean;
 ...
 * @Called
 */
public class PickViewFragment extends BaseFragment implements View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_pick_view, container, false);
        ...
        btn_Options = (Button) rootView.findViewById(R.id.btn_Options);
        btn_CustomOptions = (Button) rootView.findViewById(R.id.btn_CustomOptions);
        btn_CustomTime = (Button) rootView.findViewById(R.id.btn_CustomTime);
        Button btn_no_linkage = (Button) rootView.findViewById(R.id.btn_no_linkage);
        Button btn_to_Fragment = (Button) rootView.findViewById(R.id.btn_fragment);
        ...
        rootView.findViewById(R.id.btn_GotoJsonData).setOnClickListener(this);
        rootView.findViewById(R.id.btn_lunar).setOnClickListener(this);
        return rootView;
    }
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btn_Time && pvTime != null) {
            ...
            startActivity(new Intent(getContext(), JsonDataActivity.class));
        } else if (v.getId() == R.id.btn_fragment) {//跳转到 fragment
            startActivity(new Intent(getContext(), FragmentTestActivity.class));
